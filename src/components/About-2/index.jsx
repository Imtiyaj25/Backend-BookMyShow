...
const About = () => {
    ...
    const [ name, setName ] = useState({ first: '', last: '', designation: '' })
                            ...
                            <div class = "cv-form-row cv-form-row-about">
                                <div class = "cols-3">
                                    <div class = "form-elem">
                                        ...
                                        {/* <input name = "firstname" type = "text" className = "form-control firstname" id='firstname' onKeyUp={generateCV} placeholder="e.g. John"/> */}
                                ...
                                <div class="cols-3">
                                    ...
                                    <div class = "form-elem">
                                        ...
                                        <input name='designation' type="text" id='designation' placeholder='designation name' value={name.designation} onChange={handleInputChange} />
                    ...
                    <div class = "preview-cnt-l bg-green text-white">
                        <div class = "preview-blk">
                            ...
                            <div class = "preview-item preview-item-name">
                                <span class = "preview-item-val fw-6" id = "fullname_dsp">{name.first} {name.last}</span>
                            </div>
                            <div class = "preview-item">
                                <span class = "preview-item-val text-uppercase fw-6 ls-1" id = "designation_dsp">{name.designation}</span>
                            </div>
                        </div>
